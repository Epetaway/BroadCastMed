      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">Front-End Developer</h1>
            <h2 className="text-2xl md:text-3xl text-healthcare-primary font-medium">
              Healthcare • CMS • Email Campaigns
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              I build accessible, responsive web interfaces and enterprise email systems for
              healthcare organizations. Specializing in clinical content management, physician
              workflows, and cross-client email compatibility.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Building content management templates for treatment guidelines, physician resources,
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                newsletters, and clinical communications.
              </p>
            </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/projects" className="text-healthcare-primary hover:underline font-medium">
              View All Projects →
            </Link>
          </div>
